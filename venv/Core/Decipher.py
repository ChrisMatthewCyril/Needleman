...
'''
socrates is the module I created. It gives me the tools I need to execute my algorithm.
BenchmarkMaker is another model I created. It sets up the benchmark score.
'''
